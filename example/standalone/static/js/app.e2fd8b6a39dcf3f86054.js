...
// CONCATENATED MODULE: ./src/lib/bitshares-companion-js/lib/CompanionClient.js
...
// CONCATENATED MODULE: ./src/lib/bitshares-companion-js/main.js
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-42b46488","hasScoped":true,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/BitSharesWorker.vue
...
/* scopeId */
var __vue_scopeId__ = "data-v-42b46488"
...
/* harmony default export */ var BitSharesWidgetVoting = ({
  ...
  methods: {
    ...
    connectToChainAndStart: function connectToChainAndStart() {
      ...
      this.connector('wss://eu.nodes.bitshares.ws', true).init_promise.then(function (res) {
        _this.store.init().then(function (res) {
          // fetch now for quicker cashing
          _this.store.fetchObject('2.1.0');
    ...
    update: function update() {
      ...
      this.connector()._db.exec('get_objects', [this.workerIdList]).then(function (workers, index) {
        workers.forEach(function (worker) {
          workerList.push(worker);
        });
        _this2.loadingMessage = null;
        _this2.workerList = workerList;
      });
...
/* scopeId */
var BitSharesWidgetVoting___vue_scopeId__ = "data-v-5933be77"
/* moduleIdentifier (server only) */
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-6491e9fe","hasScoped":false,"transformToRequire":{"video":"src","source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/App.vue
var App_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"app"}},[_c('BitSharesWidgetVoting',{attrs:{"workerid":_vm.workeridfromdiv}})],1)}
var App_staticRenderFns = []
var App_esExports = { render: App_render, staticRenderFns: App_staticRenderFns }
/* harmony default export */ var selectortype_template_index_0_src_App = (App_esExports);
// CONCATENATED MODULE: ./src/App.vue
function App_injectStyle (ssrContext) {
  __webpack_require__("lKH/")
}
